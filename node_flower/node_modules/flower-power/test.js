...
FlowerPower.discover(function(flowerPower) {
  async.series([
    function(callback) {
      ...
      flowerPower.on('soilChange', function(soil) {
        console.log('soil  = ' + soil.toFixed(2) + '°C');
      });

      flowerPower.on('airChange', function(air) {
        console.log('air  = ' + air.toFixed(2) + '°C');
      });
      ...
      flowerPower.on('calibratedAirChange', function(calibratedair) {
        console.log('calibrated air  = ' + calibratedair.toFixed(2) + '°C');
      });
    ...
    function(callback) {
      console.log('readCalibratedAir');
      flowerPower.readCalibratedAir(function(error, ) {
    ...
    function(callback) {
      console.log('readAir');
      flowerPower.readAir(function(error, ) {
    ...
    function(callback) {
      console.log('readSoil');
      flowerPower.readSoil(function(error, ) {
